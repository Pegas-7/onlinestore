...
public class ClientAuthFilter implements Filter {
	private AuthenticationServiceClientImpl authServiceClient;
	private AuthenticationServiceAdministratorImpl authServiceAdministrator;

	@Override
	public void init(FilterConfig config) throws ServletException {
		authServiceClient = WebApplicationContextUtils.getRequiredWebApplicationContext(config.getServletContext())
				.getBean(AuthenticationServiceClientImpl.class);
		authServiceAdministrator = WebApplicationContextUtils
